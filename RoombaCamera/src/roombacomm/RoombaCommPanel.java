...
public class RoombaCommPanel extends JPanel implements ActionListener,ChangeListener {
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if( "comboBoxChanged".equals(action) ) {
            return;  // don't care about comboBox right now
        }
    ...
    void makeSelectPanel() {
        ...
        selectPanel.setBorder(BorderFactory.createCompoundBorder( BorderFactory.createTitledBorder("Select Roomba Port"), BorderFactory.createEmptyBorder(1,1,1,1)));
